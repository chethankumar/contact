...
//		paintBorder.setShadowLayer(5, 0, 0, Color.parseColor("#82837E"));
...
//			RectF rectFInner = new RectF(0.0f, 0.0f, viewWidth-borderWidth-4, viewHeight-borderWidth-4);
//			canvas.drawRoundRect(rect, 10, 10, paintBorder);
