...
public class Utils {
	...
	public static int getWidthForAlphabets(Activity activity) {
		return (int) ((getSizeX(activity) * 0.8) / 10);
	}
	...
	public static Typeface getTitleTypeface(Activity activity) {
		...
		// return
		// Typeface.createFromAsset(activity.getAssets(),"Nunito-Regular.ttf");
		...
		// return
		// Typeface.createFromAsset(activity.getAssets(),"Helvetica.ttf");
		// return Typeface.createFromAsset(activity.getAssets(),"Junction.otf");
		// return
		// Typeface.createFromAsset(activity.getAssets(),"Overlock-R.otf");
		// return
		// Typeface.createFromAsset(activity.getAssets(),"HoneyScript-Light.ttf");
		// return
		// Typeface.createFromAsset(activity.getAssets(),"HelveticaNeueLt.ttf");
	}
	...
	public static void addCallLogTile(Activity activity, GridLayout gridLayout, LayoutInflater inflater, String nameNumber, Date date,
			int type) {
